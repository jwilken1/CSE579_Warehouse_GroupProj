...
%New nodes to make the warehouse grid 5X5
init(object(node,17),value(at,pair(5,1))).
init(object(node,18),value(at,pair(5,2))).
init(object(node,19),value(at,pair(5,3))).
init(object(node,20),value(at,pair(5,4))).
init(object(node,21),value(at,pair(5,5))).
init(object(node,22),value(at,pair(4,5))).
init(object(node,23),value(at,pair(3,5))).
init(object(node,24),value(at,pair(2,5))).
init(object(node,25),value(at,pair(1,5))).
...
%Highway nodes for 5X5 Grid
init(object(highway,17),value(at,pair(5,1))).
init(object(highway,18),value(at,pair(5,2))).
init(object(highway,19),value(at,pair(5,3))).
init(object(highway,20),value(at,pair(5,4))).
init(object(highway,21),value(at,pair(5,5))).
init(object(highway,22),value(at,pair(4,5))).
init(object(highway,23),value(at,pair(3,5))).
init(object(highway,24),value(at,pair(2,5))).
init(object(highway,25),value(at,pair(1,5))).

init(object(pickingStation,1),value(at,pair(1,3))).
init(object(pickingStation,2),value(at,pair(3,1))).

init(object(robot,1),value(at,pair(1,5))).
init(object(robot,2),value(at,pair(5,5))).
init(object(robot,3),value(at,pair(5,1))).
